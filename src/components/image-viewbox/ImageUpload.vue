<template>
  <div class="row">
    <div class="col-auto">
      <ImageBox
        class="img-contain bg-cover"
        :src="model"
        :style="{ width, height, backgroundImage: `url(${imageBackground})` }"
      />
    </div>
    <div class="col">
      <div class="py-2">
        <button type="button" class="btn btn-danger" v-if="model.image_blob || model.image_base64" @click="clearImage">
          刪除圖片
        </button>
